...
plot(normalize(u), normalize(y), 'LineWidth', lineWidth, 'Color', 'k');
hold on;
plot(normalize(velo_at_x14d), normalize(y_at_x14d), 'Marker', 'o', ...
    'LineStyle', 'none', ...
...
plot(normalize(u2), normalize(y2), 'LineWidth', lineWidth, 'Color', 'k');
hold on;
plot(normalize(velo_at_x23d), normalize(y_at_x23d), 'Marker', 'o', ...
    'LineStyle', 'none', ...
    'MarkerSize', markerSize, ...
    'MarkerFaceColor', markerFaceColor, ...
    'MarkerEdgeColor', markerEdgeColor);
...
plot(normalize(u3), normalize(y3), 'LineWidth', lineWidth, 'Color', 'k');
hold on;
plot(normalize(velo_at_x26d), normalize(y_at_x26d), 'Marker', 'o', ...
    'LineStyle', 'none', ...
    'MarkerSize', markerSize, ...
    'MarkerFaceColor', markerFaceColor, ...
    'MarkerEdgeColor', markerEdgeColor);
...
plot(normalize(u4), normalize(y4), 'LineWidth', lineWidth, 'Color', 'k');
hold on;
plot(normalize(velo_at_x29d), normalize(y_at_x29d), 'Marker', 'o', ...
    'LineStyle', 'none', ...
    'MarkerSize', markerSize, ...
    'MarkerFaceColor', markerFaceColor, ...
    'MarkerEdgeColor', markerEdgeColor);
...
for fh = [fh1, fh2, fh3, fh4]
    ...
    xlabel('Normalized Velocity, $U/u_j$', 'Interpreter', 'Latex');
    ylabel('Normalized $y$, $y/d$', 'Interpreter', 'Latex');
